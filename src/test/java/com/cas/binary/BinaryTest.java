...
import com.cmpay.dicp.pojo.EcCardInfo;
import com.cmpay.dicp.util.EcDecryUtil;
...
//        System.out.println(RandomUtil.randomNumbers(32));
    ...
    public void test27() throws UnsupportedEncodingException {
        byte[] iv = HexConverter.hexString2ByteArray("00000000000000000000000000000000");
        System.out.println(Base64.getEncoder().encodeToString(iv));

        String data = "";
        byte[] decode = Base64.getDecoder().decode(data);
        System.out.println(HexConverter.byteArray2HexString(decode));
    }
    ...
    public void test29() {
        ...
        System.out.println(getSignString(linkedHashMap));

    }

    private String getSignString(LinkedHashMap<String, Object> linkedHashMap) {
        StringBuffer sb = new StringBuffer();
        for (Map.Entry<String, Object> entry : linkedHashMap.entrySet()) {
            Object mapValue = entry.getValue();
                sb.append(mapValue);
        }
        System.out.println("getSignString: " + sb.toString());
        return sb.toString();
    }
